...
class Pedidos(models.Model):
    ...
    estado_pedido_fk = models.ForeignKey(EstadoPedido, on_delete=models.CASCADE,db_column='estado_pedido_fk_id')
    sucursal_fk = models.ForeignKey(Sucursal, on_delete=models.SET_NULL, null=True,db_column='sucursal_fk_id')
    personal_entrega_fk = models.ForeignKey(PersonalEntrega, on_delete=models.CASCADE,db_column='personal_entrega_fk_id')
    usuario_fk = models.ForeignKey(Usuario, on_delete=models.CASCADE,db_column='usuario_fk_id')
    solicitud_fk = models.ForeignKey(Solicitudes, on_delete=models.CASCADE,db_column='solicitud_fk')
    bodega_fk = models.ForeignKey(BodegaCentral, on_delete=models.CASCADE,db_column='bodega_fk_id')
    proveedor_fk = models.ForeignKey(Proveedor, on_delete=models.SET_NULL, null=True,db_column='proveedor_fk_id')
